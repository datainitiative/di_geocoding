...
var enjoyhint_script_steps_post_add_project = [
	{
		"next .inline-related": "Here is a list of geocoding tasks added to this project.",
		"skipButton" : {className: "mySkip", text: "Exit"},
	},
	{
...
var enjoyhint_script_steps_add_task = [
	...
	{
		"next #id_project": "Select the project that this task will be added to. The project will be preselected if you come from the project page.",
		"skipButton" : {className: "mySkip", text: "Exit"},
	},
	{
...
var enjoyhint_script_steps_setup_geocoding = [
	{
		"next #panel-field-mapping": "Mapping the columns in address file to the fields requried by the geocoder.",
		"skipButton" : {className: "mySkip", text: "Exit"},
	},
	{
	...
	{
		"next #sel-city": "Select the column that contains state name. This field is required if zip code is not specified. If state is already included in street address column, leave this field as 'None'.",
		"skipButton" : {className: "mySkip", text: "Exit"},
	},
	{
